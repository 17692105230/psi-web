...
class Driver
{
    ...
    {
        return $this->engine->setMaxSize($size);
    }

    public function setAllowedExt($ext)
    {
        return $this->engine->setAllowedExt($ext);
    }

    public function setNotAllowedExt($ext)
    {
        return $this->engine->setNotAllowedExt($ext);
    }

    public function setAllowedMime($mime)
    {
        return $this->engine->setNotAllowedExt($mime);
    }
    ...
    {
        return $this->engine->setSaveName($fileName);
    }

    public function setSavePath($savePath)
    {
        return $this->engine->setSavePath($savePath);
    }
    ...
    {
        return $this->engine->getUploadFileInfo();
    }

    public function uploadImage()
    {
        $this->setAllowedExt(['jpg', 'jpeg', 'png', 'gif']);
        $this->setAllowedMime(['image/jpeg', 'image/png', 'image/gif']);
    }
