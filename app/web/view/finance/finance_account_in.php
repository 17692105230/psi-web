<div class="easyui-layout" data-options="fit:true">
	<div data-options="
        ...
        split:true,
        collapsible:false,
        footer:'#win_finance_account_in_footer'" style="width:360px;padding:10px;">
		<form id="win_finance_account_in_form" method="post">
			<div class="form-clo1">
    ...
    <div id="win_finance_account_in_footer" style="text-align:right;padding:5px;overflow:hidden;height:45px;">
        <a class="easyui-linkbutton" data-options="iconCls:'icon-save',onClick:$.h.fa.winIn.save" style="width:100%;height:100%;">提交</a>
    </div>
</div>