<div class="easyui-layout" data-options="fit:true">
	<div data-options="
        ...
        split:true,
        collapsible:false,
        footer:'#win_finance_account_begin_footer'" style="width:360px;padding:10px;">
		<form id="win_finance_account_begin_form" method="post">
			<div class="form-clo1">
				<div class="name w">账户:</div>
				<div class="ctl w">
			...
			<div class="form-clo1">
				...
				<div class="ctl w">
					<input id="income" name="income" class="easyui-numberspinner" data-options="width:200,buttonText:'元',required:true,validType:'zero',value:0,prefix:'￥',precision:2"/>
				</div>
				<div class="kbi_c"></div>
			</div>
			<div class="form-clo1">
    ...
    <div id="win_finance_account_begin_footer" style="text-align:right;padding:5px;overflow:hidden;height:45px;">
        <a class="easyui-linkbutton" data-options="iconCls:'icon-save',onClick:$.h.fa.winBegin.save" style="width:100%;height:100%;">提交</a>
    </div>
</div>