<div class="easyui-panel"
    ...
    <header class="header-hover">
        ...
        <div style="float:right;">
            ...
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:1">草稿</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:9">已盘点</a>
        </div>
    </header>
		...
		<div style="height:172px;background-color:#eee;padding:10px 10px 0px 10px;border-bottom: 1px solid #ccc;"
			...
			<form id="list_search_form" method="post">
				...
				<div class="form-clo1">
					...
					<div class="ctl w">
						<input name="search_warehouse_name" class="easyui-textbox" style="width:100%;" /input>
					</div>
				</div>
				<div class="form-clo1">
				...
				<div class="form-clo1">
					...
					<div class="ctl w" style="display:flex;justify-content:space-between;align-items:center;">
						...
						<a class="easyui-linkbutton" style="width:70px;margin-right:15px;"
							...
							">重置</a>
						<a class="easyui-linkbutton" data-options="iconCls:'icon-search'" style="width:100px;margin-right:15px;">查询</a>
					</div>
				</div>
			</form>
		</div>
		<div data-options="region:'center',border:false">
			<table id="orders_list" class="easyui-datagrid"
				data-options="
					...
					singleSelect:true,
					method:'post',
					url:$.toUrl('cell_editing', 'LoadApplyList'),
					pagination: true,
					pageSize: 25,
                    showPageList: false,
