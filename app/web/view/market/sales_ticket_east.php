                    ...
                    <div class="form-clo1">
                        ...
                        <a class="easyui-linkbutton" style="width:70px;margin-right:15px;"
                           data-options="
							...
							">重置</a>
                        <a class="easyui-linkbutton" data-options="iconCls:'icon-search',onClick:$.h.so.searchOrdersList" style="width:100px;margin-right:15px;">查询</a>
                        </div>
                    </div>
        ...
        <div data-options="region:'center',border:false">
            <table id="orders_list" class="easyui-datagrid"
                   data-options="
					...
					singleSelect:true,
					method:'post',
					url:'/manage/sale/loadOrdersList',
					pagination: true,
					pageSize: 25,
                    showPageList: false,
