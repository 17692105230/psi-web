<div class="easyui-panel"
    ...
    <header class="header-hover">
        ...
        <div style="float:right;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-reload',toggle:true,group:'g1',selected:true,plain:true,status:-1,onClick:$.h.pp.loadPlansList" style="color:blue;font-weight:bold">全部</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:0,onClick:$.h.pp.loadPlansList">草稿</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:9,onClick:$.h.pp.loadPlansList">已提交</a>
        </div>
    </header>
                ...
                <div class="form-clo1">
					...
					<div class="ctl w" style="text-align:right;">
						...
						<a class="easyui-linkbutton" style="width:70px;margin-right:15px;"
							...
							">重置</a>
						<a class="easyui-linkbutton" data-options="iconCls:'icon-search',onClick:$.h.pp.searchPlansList" style="width:100px;">查询</a>
					</div>
                </div>
			</form>
		</div>
		<div data-options="region:'center',border:false">
			<table id="plans_list" class="easyui-datagrid"
				data-options="
					fit: true,
					fitColumns:true,
					border: false,
					...
					singleSelect:true,
					method:'get',
					url:'/web/purchase/loadPlansList',
					pagination: true,
					pageSize: 25,
                    showPageList: false,
                    displayMsg: '共 {total} 行',
					onLoadSuccess: function(data) { },
					onDblClickRow:$.h.pp.onOrdersDblClickRow,
                    onClickCell:$.h.pp.onOrdersClickCell
					">
				<thead>
					<tr>
						...
						<th data-options="
							...
							"><strong>状态</strong></th>
						<th data-options="field:'orders_id2',align:'center',formatter:$.h.pp.modifyFormatter"></th>
					</tr>
				</thead>
			</table>
		</div>
