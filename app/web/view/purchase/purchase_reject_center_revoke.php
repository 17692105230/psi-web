<div class="easyui-layout" data-options="fit:true">
	...
	">
		<header class="header-hover">
            ...
            <div id="orders_grid_reject_revoke_toolbar" style="float:right;">
        ...
        <div class="form-clo2">
            ...
            <div class="form-clo2">
				...
				<div class="ctl w"><div id="orders_date" class="name" style="text-align: left"></div></div>
				<div class="name w"><strong>备注:</strong></div>
				<div class="ctl w"><div id="orders_remark" class="name" style="text-align: left"></div></div>
        </div>
	</div>
	<div data-options="region:'center'" style="overflow:hidden;border-top:1px solid #ddd;">
		<table id="orders_grid_details" class="easyui-datagrid" style="width:100%;" title=""
			data-options="
				...
				method:'get',
				onBeforeLoad:$.h.pr.reject.onBeforeLoad,
				rownumbers:true,
				multiSort:true,
				remoteSort:false
			">
