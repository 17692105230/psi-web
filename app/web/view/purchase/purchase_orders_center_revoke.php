<div class="easyui-layout" data-options="fit:true">
	<div class="easyui-panel" style="overflow-x:hidden;padding:10px 10px 0px 10px;width:100%;height:120px;background-color:#eee;"
		data-options="
			region:'north',
			split:true,
	...
	">
		<header class="header-hover">
            ...
            <div id="orders_grid_revoke_toolbar" style="float:right;">
				<a class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">导出Excel</a>
				<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true,onClick:$.h.po.mCopyToNewOrders">复制为采购退货单</a>
				<a class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true,onClick:$.h.po.mNewOrders">新建单据</a>
            </div>
        </header>
		<form id="purchase_orders_form" method="post">
			<input id="purchase_orders_code" name="purchase_orders_code" type="hidden" value=""/>
            <div class="form-clo2">
                <div class="name w"><strong>供应商:</strong></div>
                <div class="ctl w">
                    <div id="supplier_name" class="name" style="text-align: left"></div>
                </div>
                <div class="name w"><strong>仓库:</strong></div>
                <div class="ctl w">
                    <div id="warehouse_name" class="name" style="text-align: left"></div>
                </div>
                <div class="name w"><strong>结算账户:</strong></div>
                <div class="ctl w">
                    <div id="settlement_name" class="name" style="text-align: left"></div>
                </div>
            </div>
            <div class="form-clo2">
                <div class="name w"><strong>实付金额:</strong></div>
                <div class="ctl w">
                    <div id="orders_rmoney" class="name" style="text-align: left"></div>
                </div>
                <div class="name w"><strong>日期:</strong></div>
                <div class="ctl w">
                    <div id="orders_date" class="orders_date" style="text-align: left"></div>
                </div>
                <div class="name w"><strong>备注:</strong></div>
                <div class="ctl w">
                    <div id="orders_remark" class="orders_remark" style="text-align: left"></div>
                </div>
            </div>
		</form>
	</div>
	<div data-options="region:'center'" style="overflow:hidden;border-top:1px solid #ddd;">
		<table id="orders_grid_details" class="easyui-datagrid" style="width:100%;"
			data-options="
				...
				method:'get',
				onBeforeLoad:$.h.po.reject.onBeforeLoad,
				rownumbers:true,
				multiSort:true,
				remoteSort:false
			">
