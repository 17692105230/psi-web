<div class="easyui-panel"
    ...
    <header class="header-hover">
        ...
        <div style="float:right;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-reload',toggle:true,group:'g1',selected:true,plain:true,status:-1,onClick:$.h.po.loadOrdersList" style="color:blue;font-weight:bold">全部</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:8,onClick:$.h.po.loadOrdersList">订单</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:0,onClick:$.h.po.loadOrdersList">草稿</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:9,onClick:$.h.po.loadOrdersList">已采购</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:1,onClick:$.h.po.loadOrdersList">已撤销</a>
        </div>
    </header>
            ...
            <form id="list_search_form" method="post">
                ...
                <div class="form-clo1">
                    ...
                    <div class="form-clo1">
                        ...
                        <div class="ctl w">
                            <input name="supplier_name" class="easyui-textbox" style="width:100%;" /input>
                        </div>
                    </div>
                    <div class="form-clo1">
                        <div class="name w">单号:</div>
                        <div class="ctl w">
                            <input name="orders_code" class="easyui-textbox" style="width:100%;" /input>
                        </div>
                    </div>
                    <div class="form-clo1">
                        ...
                        <a class="easyui-linkbutton" style="width:70px;margin-right:15px;"
                           data-options="
							...
							">重置</a>
                        <a class="easyui-linkbutton" data-options="iconCls:'icon-search',onClick:$.h.po.searchOrdersList" style="width:100px;">查询</a>
                        </div>
                    </div>
        ...
        <div data-options="region:'center',border:false">
            <table id="orders_list" class="easyui-datagrid"
                   data-options="
					...
					singleSelect:true,
					method:'post',
					url:'/web/purchase/loadOrdersList',
                    pagination: true,
					pageSize: 25,
                    showPageList: false,
                    displayMsg: '共 {total} 行',
					onLoadSuccess: function(data) { },
					onDblClickRow:$.h.po.onOrdersDblClickRow,
                    onClickCell:$.h.po.onOrdersClickCell
					">
                <thead>
                <tr>
                    ...
                    <th data-options="
								...
								formatter: function(value,row,index) {
									switch(parseInt(value)) {
										...
										case 8:
											return '<font color=blue><b>订单</b></font>';
										case 9:
							...
							"><strong>状态</strong></th>
                    <th data-options="field:'orders_id2',align:'center',formatter:$.h.po.modifyFormatter"></th>
                </tr>
                </thead>
            </table>
        </div>
