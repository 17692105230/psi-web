<div class="easyui-panel"
    ...
    <header class="header-hover">
        ...
        <div style="float:right;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-reload',toggle:true,group:'g1',selected:true,plain:true,status:-1,onClick:$.h.sro.loadOrdersList" style="color:blue;font-weight:bold">全部</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:8,onClick:$.h.sro.loadOrdersList">订单</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:0,onClick:$.h.sro.loadOrdersList">草稿</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:9,onClick:$.h.sro.loadOrdersList">已退货</a>
        </div>
    </header>
                ...
                <div class="form-clo1">
                    ...
                    <div class="ctl w" style="display:flex;justify-content:space-between;align-items:center;">
                        <div style="width:calc(50% - 15px);">
                            <input id="search_orders_date" name="orders_date" class="easyui-datebox" style="width:100%;" /input>
                        </div>
        ...
        <div data-options="region:'center',border:false">
            <table id="orders_list" class="easyui-datagrid"
                   data-options="
					...
					singleSelect:true,
					method:'post',
					url:'/web/sale_reject_order/loadRejectOrdersList',
					pagination: true,
					pageSize: 25,
                    showPageList: false,
                    displayMsg: '共 {total} 行',
					onLoadSuccess: function(data) { },
                    onDblClickRow:$.h.sro.onOrdersDblClickRow,
                    onClickCell:$.h.sro.onOrdersClickCell
					">
                <thead>
                <tr>
                    ...
                    <th data-options="
							...
							"><strong>状态</strong></th>
                    <th data-options="field:'orders_id2',align:'center',formatter:$.h.sro.modifyFormatter"></th>
                </tr>
                </thead>
            </table>
        </div>
