                ...
                <div class="form-clo1">
					...
					<div class="form-clo1">
						...
						<a class="easyui-linkbutton" style="width:70px;margin-right:15px;"
							...
							">重置</a>
						<a class="easyui-linkbutton" data-options="iconCls:'icon-search',onClick:$.h.sra.searchOrdersList" style="width:100px;">查询</a>
                    </div>
				</div>
			</form>
		</div>
		<div data-options="region:'center',border:false">
			<table id="orders_list" class="easyui-datagrid"
				data-options="
					...
					singleSelect:true,
					method:'post',
					url:'/web/sale_reject_apply/loadApplyList',
					pagination: true,
					pageSize: 25,
                    showPageList: false,
