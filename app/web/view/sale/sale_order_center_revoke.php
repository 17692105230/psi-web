<div class="easyui-layout" data-options="fit:true">
    <div class="easyui-panel" title="销售单"
         style="overflow-x:hidden;padding:10px 10px 0px 10px;width:100%;height:170px;background-color:#eee;"
         data-options="
			region:'north',
			split:true,
	...
	">
        <header class="header-hover">
            <div style="float:left;margin-top:5px;">
                <span style="font-weight:bold;">销售单 - <span id="orders_code_view"
            ...
            <div id="orders_grid_toolbar" style="float:right;">
                ...
                <a href="javascript:void(0)" class="easyui-linkbutton"
                   data-options="iconCls:'icon-remove',plain:true,onClick:$.h.so.mCopyToNewOrders">复制为销售退货单</a>
                <a class="easyui-linkbutton"
                   data-options="iconCls:'icon-add',plain:true,onClick:$.h.so.mNewOrders">新建单据</a>
    ...
    <div data-options="region:'center'" style="overflow:hidden;">
        <table id="orders_grid_details" class="easyui-datagrid" style="width:100%;"
               data-options="
				...
				method:'get',
                onBeforeLoad:$.h.so.reject.onBeforeLoad
			">
            <thead>
            <tr>
