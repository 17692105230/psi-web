	...
	">
		<header class="header-hover">
            ...
            <div style="float:right;">
				<a class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true,onClick:$.h.sra.mNewOrders">新建订单</a>
            </div>
        </header>
		<form id="orders_form" method="post">
			...
			<div class="form-clo1">
					...
					<div class="name w" style="font-weight:bold;color:brack">客户:</div>
					<div class="ctl w">
                        <div id="client_name" class="name" style="text-align: left"></div>
					</div>


					<div class="name w" style="font-weight:bold;color:brack">申请日期:</div>
					<div class="ctl w">
	...
	<div data-options="region:'center'" style="overflow:hidden;border-top:1px solid #ddd;">
		<table id="orders_grid_details" class="easyui-datagrid" style="width:100%;" title=""
			data-options="
				...
				method:'get',
				onBeforeLoad:$.h.sra.complete.onBeforeLoad
			">
			<thead>
				<tr>
		...
		<div id="orders_grid_details_footer" style="padding:2px 5px;">
			...
			<div style="float:right;">
				合计数量:<input id="goods_number" class="easyui-numberbox" style="width:80px;" data-options="readonly:true,min:0,max:9999999,precision:0,value:0"/>
				合计金额:<input id="orders_pmoney" class="easyui-numberbox" style="width:120px;" data-options="readonly:true,min:0,max:9999999,prefix:'￥',precision:2,value:0"/>
			</div>
		</div>
	</div>
</div>