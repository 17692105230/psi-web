<div class="easyui-panel"
    ...
    <header class="header-hover">
        ...
        <div style="float:right;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-reload',toggle:true,group:'g1',selected:true,plain:true,status:-1,onClick:$.h.sp.loadOrdersList" style="color:blue;font-weight:bold">全部</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:0,onClick:$.h.sp.loadOrdersList">草稿</a>
            <a class="easyui-linkbutton" data-options="toggle:true,group:'g1',plain:true,status:9,onClick:$.h.sp.loadOrdersList">已完成</a>
        </div>
    </header>
                    ...
                    <div class="ctl w" style="text-align:right;">
                        ...
                        <a class="easyui-linkbutton" style="width:70px;margin-right:15px;"
                           data-options="
							...
							">重置</a>
                        <a class="easyui-linkbutton" data-options="iconCls:'icon-search',onClick:$.h.sp.searchOrdersList" style="width:100px;">查询</a>
                    </div>
                </div>
            </form>
        </div>
        <div data-options="region:'center',border:false">
            <table id="orders_list" class="easyui-datagrid"
                   data-options="
					...
					singleSelect:true,
					method:'post',
					url:'/web/sale/loadPlanList',
					pagination: true,
					pageSize: 25,
                    showPageList: false,
                    displayMsg: '共 {total} 行',
					onLoadSuccess: function(data) { },
                    onDblClickRow:$.h.sp.onOrdersDblClickRow,
                    onClickCell:$.h.sp.onOrdersClickCell
					">
                <thead>
                <tr>
                    ...
                    <th data-options="
							...
							"><strong>状态</strong></th>
                    <th data-options="field:'orders_id2',align:'center',formatter:$.h.sp.modifyFormatter"></th>
                </tr>
                </thead>
            </table>
        </div>
